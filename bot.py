...
TEXTS = {
    "ru": {
        ...
        "media_fallback": "Здравствуйте! Пожалуйста, изложите суть вашего вопроса текстом в одном сообщении."
    },
    "en": {
        ...
        "media_fallback": "Hello! Please state the core of your inquiry in one text message."
    }
}
...
# ⚡️ ТОЛЬКО ПРОВЕРЕННЫЕ УМНЫЕ МОДЕЛИ (Llama 8B убрана)
PUBLIC_MODELS = [
