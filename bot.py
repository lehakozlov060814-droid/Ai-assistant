...
# 🛡 Шаблоны спам-приглашений и схем
...
TEXTS = {
    "ru": {
        ...
        "about_text": (
            ...
            "• <b>Антиспам:</b> мгновенный отсев нецелевых обращений без отправки в ЛС."
        ),
        "btn_summary": "📋 Выжимка",
        "btn_menu_new": "⚙️ Меню",
    ...
    "en": {
        ...
        "about_text": (
            ...
            "• <b>Human Takeover:</b> Mutes bot for 3h when owner replies in chat.\n"
            "• <b>Anti-Spam:</b> Discards spam without flooding owner DM."
        ),
        "btn_summary": "📋 Summary",
        "btn_menu_new": "⚙️ Menu",
...
async def handle_business(message: types.Message):
    ...
    # 🛑 HUMAN TAKEOVER: если пишет владелец — глушим бота в этом чате на 3 часа (10800 сек)
    ...
    try:
        ...
        # 🛑 Проверка спама (не отправляем в ЛС, если сработала фраза про удаление чата)
