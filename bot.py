...
MODEL_PRETTY_NAMES = {
    ...
    "google/gemini-2.0-flash-001": "Gemini 2.0 Flash ⚡️",
    "google/gemini-2.0-flash": "Gemini 2.0 Flash ⚡️",
    "google/gemini-flash-1.5": "Gemini 1.5 Flash ⚡️",
    "google/gemini-pro-1.5": "Gemini 1.5 Pro 💫",
    "meta-llama/llama-3.3-70b-instruct": "Llama 3.3 70B 🦙",
    "anthropic/claude-3.5-sonnet": "Claude 3.5 Sonnet 🎭",
    "anthropic/claude-3-haiku": "Claude 3 Haiku ⚡️",
    "openai/gpt-4o": "ChatGPT-4o 🟢",
    "openai/gpt-4o-mini": "ChatGPT-4o Mini 🟢",
...
TEXTS = {
    "ru": {
        ...
        "about_text": (
            ...
            "🤖 <b>Раздельные модели:</b> отдельные нейросети для ЛС и секретаря."
        ),
        "btn_summary": "📋 Выжимка",
...
PUBLIC_MODELS = [
    ...
    ("🔹 Gemini 2.0 Flash ⚡️", "google/gemini-2.0-flash-001"),
...
async def handle_business(message: types.Message):
    ...
    # Human Takeover: если пишет владелец — глушим бота на 3 часа
    ...
    try:
        ...
        # Проверяем, отшивал ли уже бот этого собеседника ранее
        ...
        # Медиа без текста (стикеры, гифки)
        if is_media_without_text:
            if was_dismissed:
                # Если уже просили покинуть чат — повторяем отказ без любезностей
                ...
                # Если первый контакт — просим нейтрально написать текст без "Здравствуйте"
